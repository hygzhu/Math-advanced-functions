...
<link rel="shortcut icon"
	href="http://www.iconj.com/icon.php?pid=cpvk8i0sha" type="image/x-icon" />
<link rel="shortcut icon"
	href="http://www.iconj.com/gif_icon.php?pid=cpvk8i0sha"
	type="image/gif" />
...
%>
	...
	<div class="blog-masthead">
		<div class="container">
			<nav class="blog-nav"> <a class="blog-nav-item active"
				href="http://math-afunctions.rhcloud.com/UserMainPage.jsp">Home</a>
			<a class="blog-nav-item"
				href="http://math-afunctions.rhcloud.com/Questions.jsp#">Question</a>
			</nav>
		</div>
	</div>
	...
	<div class="container">
		...
		<div class="blog-header">
			<h1 class="blog-title">Quiz Bank</h1>
		</div>
		...
		<div class="row">
			...
			<div class="col-sm-8 blog-main">
				...
				<div class="blog-post">
					...
					<div class="jumbotron">
						<h1>Question<%out.println(quizID); %></h1>
						<center>
			...
			<div class="col-sm-3 col-sm-offset-1 blog-sidebar">
				<div class="sidebar-module sidebar-module-inset">
					...
					<form action="/DisplayQuiz" method="post">
						...
						Insert Quiz ID: <input type="text" name="quizID" /> <input
							type="submit" />
					</form>

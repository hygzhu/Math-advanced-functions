<!-- Original page after users login, now replaced my 1_MainPage -->
	...
	<div class="container">
		<div class="navbar-header">
			...
			<a class="navbar-brand"
				href="http://math-afunctions.rhcloud.com/UserMainPage.jsp">Math
				AF</a>
		</div>
		<div id="navbar" class="collapse">
			<ul class="nav">
				<li class="active"><a
					href="http://math-afunctions.rhcloud.com/UserMainPage.jsp">Home</a></li>
				<li><a href="http://math-afunctions.rhcloud.com/Questions.jsp#">Questions</a></li>
				<li><a href="http://math-afunctions.rhcloud.com/Quiz.jsp#">Quiz</a></li>
	...
	<div class="container">
		...
		<div class="row row-offcanvas row-offcanvas-right">
			...
			<div class="col-xs-12 col-sm-9">
				...
				<div class="jumbotron">
					<h1>Hello, world!</h1>
					<p>This is the main page for the student and the teacher, there
						would be a calender that displays all the dates</p>
					<p><a href="http://math-afunctions.rhcloud.com/UserMainPage.jsp">Homepage</a></p>
			...
			<div class="col-xs-6 col-sm-3 sidebar-offcanvas" id="sidebar">
				<div class="list-group">
					...
					<a href="#" class="list-group-item">Online derivative
						calculator</a>
				</div>
			</div>
			<!--/.sidebar-offcanvas-->

      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="http://math-afunctions.rhcloud.com/Questions.jsp#">Questions</a></li>
    ...
    <div class="container">
      ...
      <div class="row row-offcanvas row-offcanvas-right">
        ...
        <div class="col-xs-12 col-sm-9">
          ...
          <div class="jumbotron">
            <h1>Questions</h1>
            <p>This is the page for the questions, and it will contain a link to the question bank</p>
            <a href="http://math-afunctions.rhcloud.com/DisplayQuiz">Question Bank!</a>
             <h4>For mobile</h4>

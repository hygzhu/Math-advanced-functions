<!-- Student center, now discontinued -->
      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="http://math-afunctions.rhcloud.com/StudentCenter.jsp#">Students</a></li>
      ...
      <div class="row row-offcanvas row-offcanvas-right">
        ...
        <div class="col-xs-12 col-sm-9">
          ...
          <div class="jumbotron">
            ...
            <p>This is page to display all the students and will have menus to toggle through their marks!</p>
          </div>
          <div class="row">

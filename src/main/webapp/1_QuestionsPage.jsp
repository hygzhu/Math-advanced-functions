...
<!-- Navigation bar at the top -->		
	...
	<div class="container">
		...
		<div id="navbar" class="collapse navbar-collapse">
			<ul class="nav navbar-nav">
				...
				<li class="active"><a href="http://math-afunctions.rhcloud.com/1_QuestionsPage.jsp">Quiz Questions</a></li>
		...
		<div class="row row-offcanvas row-offcanvas-right">
			...
			<div class="col-xs-12 col-sm-9">
				<p class="pull-right visible-xs">
				 ...
				 <div class="jumbotron">
            <h1>Question Bank</h1>
            <p>Click to view all the available questions or create a new question.</p>
            <p><a href="http://math-afunctions.rhcloud.com/DisplayQuiz">View Question Bank</a></p>
            <p><a href="http://math-afunctions.rhcloud.com/QuizCreation.jsp">Create a new quiz question</a></p>
            <h4>For mobile</h4>
	...
	<script src="offcanvas.js"></script>
		...
		response.sendRedirect("WelcomePage.jsp");//sends users back to main page if not teacher
		}
	%>
